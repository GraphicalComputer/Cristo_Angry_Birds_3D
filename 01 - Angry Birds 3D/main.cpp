        ...
        while(lca){
            if(lca->face.face [f]!=-1){
                while(lva){
                    for(f=0;f<MAX;f++){
                        // V2 X V1
                        vec1.x=lva[lca[f].ID[]].x-lva[lca[f].ID[]].x;
                        vec1.y=lva[lca[f].ID[]].y-lva[lca[f].ID[]].y;
                        vec1.z=lva[lca[f].ID[]].z-lva[lca[f].ID[]].z;
                        // V3 - V1
                        vec2.x=lva[lca[f].ID[]].x-lva[lca[f].ID[]].x;
                        vec2.y=lva[lca[f].ID[]].y-lva[lca[f].ID[]].y;
                        vec2.z=lva[lca[f].ID[]].z-lva[lca[f].ID[]].z;
                        // N = vec1 X vec2
